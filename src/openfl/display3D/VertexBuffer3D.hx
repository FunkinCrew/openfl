		...
		if (__context.isBGFX)
		{
			...
			switch (__usage)
			{
				...
				case DYNAMIC_DRAW:
						...
						switch (__vbh)
						{
							case Dynamic(dvb):
								...
								else
								{
									...
									__vbh = Dynamic(bgfx.createDynamicVertexBufferMem(mem, __vlayouts[__defaultMainLayoutKey].layout,
										bgfx.BUFFER_ALLOW_RESIZE));
								}
							default:
						}
					}
					...
					{
						__vbh = Dynamic(bgfx.createDynamicVertexBufferMem(mem, __vlayouts[__defaultMainLayoutKey].layout, bgfx.BUFFER_ALLOW_RESIZE));
					}
			}
