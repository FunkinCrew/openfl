...
interface IContext3D
{
	...
	public var bgfx:BGFXRenderContext;
	...
	private function __flushFramebuffer():Void;
	private function __flushViewport():Void;
	...
	private function __invalidateGLTexture2D(texture:Dynamic):Void;
