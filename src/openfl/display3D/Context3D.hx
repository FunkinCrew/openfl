...
class Context3D extends EventDispatcher
{
	...
	@:noCompletion private var __vertexConstants:#if lime openfl.utils._internal.Float32Array #else Dynamic #end;
	@:noCompletion private var __fragmentConstants:#if lime openfl.utils._internal.Float32Array #else Dynamic #end;
	...
	@SuppressWarnings("checkstyle:Dynamic")
	public var bgfx(get, never):#if lime BGFXRenderContext #else Dynamic #end;
	...
	**/
	...
	@SuppressWarnings("checkstyle:Dynamic") @:noCompletion private function __bindGLTexture2D(texture:Dynamic):Void
		__backend.__bindGLTexture2D(texture);

	@SuppressWarnings("checkstyle:Dynamic") @:noCompletion private function __bindGLTextureCubeMap(texture:Dynamic):Void
		__backend.__bindGLTextureCubeMap(texture);

	@SuppressWarnings("checkstyle:Dynamic") @:noCompletion private function __bindGLArrayBuffer(buffer:Dynamic):Void
		__backend.__bindGLArrayBuffer(buffer);

	@SuppressWarnings("checkstyle:Dynamic") @:noCompletion private function __bindGLElementArrayBuffer(buffer:Dynamic):Void
		__backend.__bindGLElementArrayBuffer(buffer);

	@SuppressWarnings("checkstyle:Dynamic") @:noCompletion private function __bindGLFramebuffer(framebuffer:Dynamic):Void
